...
export const HeroPro = () => {
  ...
  const nebulaOpacity = useTransform(scrollYProgress, [0, 0.6, 1], [0.72, 0.48, 0.18]);
    ...
    <LiquidBackground>
      <section ref={sectionRef} id="hero" className="relative min-h-screen overflow-hidden">
        ...
        <motion.div
          ...
          style={{ y: geometryY, opacity: 0.28 }}
        >
          <SacredGeometry type="golden-spiral" size={360} color="hsl(var(--renaissance-gold))" animated />
        </motion.div>
            ...
            >
              ...
              <div className="space-y-8">
                ...
                >
                  <TextReveal 
                    as="span" 
                    className="block text-transparent bg-gradient-to-r from-white via-cosmic-dawn to-white bg-clip-text font-philosophical text-6xl md:text-8xl lg:text-9xl font-bold tracking-tight drop-shadow-2xl"
                  >
                    The Inevitable
                  </TextReveal>
                  <span className="mt-8 block text-center text-transparent bg-gradient-to-r from-phoenix-red via-quantum-violet to-cosmic-dawn bg-clip-text font-elegant text-xl md:text-2xl lg:text-3xl font-medium leading-relaxed max-w-5xl mx-auto">
                ...
                <motion.p
                  ...
                  className="mx-auto max-w-5xl text-balance text-lg leading-relaxed text-gray-800 md:text-xl lg:text-2xl font-elegant drop-shadow-xl"
                >
